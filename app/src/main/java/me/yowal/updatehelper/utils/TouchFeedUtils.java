...
public class TouchFeedUtils {
     ...
     * 私有构造函数
     */
    private TouchFeedUtils(Context context){
     ...
     * 单例模式
     */
    private static volatile TouchFeedUtils touchFeedback;
    public static synchronized TouchFeedUtils getInstance(Context context){
        if (touchFeedback == null) {
            synchronized (TouchFeedUtils.class) {
                if (touchFeedback == null) {
                    touchFeedback = new TouchFeedUtils(context);
                }
            }
        }
