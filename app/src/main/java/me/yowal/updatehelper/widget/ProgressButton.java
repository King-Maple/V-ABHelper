package me.yowal.updatehelper.widget;
...
public class ProgressButton extends AppCompatTextView {
    ...
    public static final int STATE_INSTALL = 1;//下载之中
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            mBackgroundColor = a.getColor(R.styleable.ProgressButton_progress_btn_background_color, Color.parseColor("#3385FF"));
            mBackgroundSecondColor = a.getColor(R.styleable.ProgressButton_progress_btn_background_second_color, Color.parseColor("#E8E8E8"));
            mButtonRadius = a.getDimension(R.styleable.ProgressButton_progress_btn_radius, 0);
            mTextColor = a.getColor(R.styleable.ProgressButton_progress_btn_text_color, mBackgroundColor);
            mTextCoverColor = a.getColor(R.styleable.ProgressButton_progress_btn_text_cover_color, Color.WHITE);
            mBorderWidth = a.getDimension(R.styleable.ProgressButton_progress_btn_border_width, dp2px(2));
            mBallStyle = a.getInt(R.styleable.ProgressButton_progress_btn_ball_style, STYLE_BALL_JUMP);
        } finally {
            a.recycle();
        }
    }
    ...
    private void init() {
        ...
        mTextPaint.setTextSize(sp2px(16.f));
